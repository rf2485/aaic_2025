...
if [ ! -f $t1dir/group_qc/aparc+aseg2diff/index.html ]; then
	...
	for subj in "${subj_list[@]}"; do
		if [ ! -f $t1dir/group_qc/aparc+aseg2diff/$subj.png ]; then
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/aparc+aseg2diff.mgz:colormap=lut:opacity=0.2 -viewport 'x' -slice 38 48 33 -nocursor -screenshot $t1dir/group_qc/aparc+aseg2diff/grota.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/aparc+aseg2diff.mgz:colormap=lut:opacity=0.2 -viewport 'x' -slice 48 48 33 -nocursor -screenshot $t1dir/group_qc/aparc+aseg2diff/grotb.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/aparc+aseg2diff.mgz:colormap=lut:opacity=0.2 -viewport 'x' -slice 58 48 33 -nocursor -screenshot $t1dir/group_qc/aparc+aseg2diff/grotc.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/aparc+aseg2diff.mgz:colormap=lut:opacity=0.2 -viewport 'y' -slice 48 38 33 -nocursor -screenshot $t1dir/group_qc/aparc+aseg2diff/grotd.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/aparc+aseg2diff.mgz:colormap=lut:opacity=0.2 -viewport 'y' -slice 48 48 33 -nocursor -screenshot $t1dir/group_qc/aparc+aseg2diff/grote.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/aparc+aseg2diff.mgz:colormap=lut:opacity=0.2 -viewport 'y' -slice 48 58 33 -nocursor -screenshot $t1dir/group_qc/aparc+aseg2diff/grotf.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/aparc+aseg2diff.mgz:colormap=lut:opacity=0.2 -viewport 'z' -slice 48 48 26 -nocursor -screenshot $t1dir/group_qc/aparc+aseg2diff/grotg.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/aparc+aseg2diff.mgz:colormap=lut:opacity=0.2 -viewport 'z' -slice 48 48 33 -nocursor -screenshot $t1dir/group_qc/aparc+aseg2diff/groth.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/aparc+aseg2diff.mgz:colormap=lut:opacity=0.2 -viewport 'z' -slice 48 48 40 -nocursor -screenshot $t1dir/group_qc/aparc+aseg2diff/groti.png
...
if [ ! -f $t1dir/group_qc/jhu2diff/index.html ]; then
	...
	for subj in "${subj_list[@]}"; do
		if [ ! -f $t1dir/group_qc/jhu2diff/$subj.png ]; then
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/jhu2diff.mgz:colormap=lut:opacity=0.2 -viewport 'x' -slice 38 48 33 -nocursor -screenshot $t1dir/group_qc/jhu2diff/grota.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/jhu2diff.mgz:colormap=lut:opacity=0.2 -viewport 'x' -slice 48 48 33 -nocursor -screenshot $t1dir/group_qc/jhu2diff/grotb.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/jhu2diff.mgz:colormap=lut:opacity=0.2 -viewport 'x' -slice 58 48 33 -nocursor -screenshot $t1dir/group_qc/jhu2diff/grotc.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/jhu2diff.mgz:colormap=lut:opacity=0.2 -viewport 'y' -slice 48 38 33 -nocursor -screenshot $t1dir/group_qc/jhu2diff/grotd.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/jhu2diff.mgz:colormap=lut:opacity=0.2 -viewport 'y' -slice 48 48 33 -nocursor -screenshot $t1dir/group_qc/jhu2diff/grote.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/jhu2diff.mgz:colormap=lut:opacity=0.2 -viewport 'y' -slice 48 58 33 -nocursor -screenshot $t1dir/group_qc/jhu2diff/grotf.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/jhu2diff.mgz:colormap=lut:opacity=0.2 -viewport 'z' -slice 48 48 26 -nocursor -screenshot $t1dir/group_qc/jhu2diff/grotg.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/jhu2diff.mgz:colormap=lut:opacity=0.2 -viewport 'z' -slice 48 48 33 -nocursor -screenshot $t1dir/group_qc/jhu2diff/groth.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/jhu2diff.mgz:colormap=lut:opacity=0.2 -viewport 'z' -slice 48 48 40 -nocursor -screenshot $t1dir/group_qc/jhu2diff/groti.png
